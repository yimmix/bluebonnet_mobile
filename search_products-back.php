<?php 
	...
	(SELECT product_id from product_labels where label_id=".$val;
		...
		$total_product = $product_obj->cntSearchedproduct($cond);
		if($total_product > 0){
		$product_lists = $product_obj->getSearchedProductsDetail($page,$cond);
		$filter_options = $product_obj->getFilterOptions($page,$cond);
